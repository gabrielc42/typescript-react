      ...
      return {
        build: (options2 = {}) => {
          if (cwd) {
            ...
            if (!absWorkingDir)
              options2 = {...options2, absWorkingDir: cwd};
          }
        ...
        serve(serveOptions, buildOptions = {}) {
          if (cwd) {
            ...
            if (!absWorkingDir)
              buildOptions = {...buildOptions, absWorkingDir: cwd};
          }
...
var startService = longLivedService(() => process.cwd(), (options) => {
  ...
  let child = child_process.spawn(command, args.concat(`--service=${"0.8.57"}`, "--ping"), {
    windowsHide: true,
...
var runServiceSync = (callback) => {
  ...
  callback(service);
  let stdout = child_process.execFileSync(command, args.concat(`--service=${"0.8.57"}`), {
    cwd: process.cwd(),
    windowsHide: true,
    input: stdin,
